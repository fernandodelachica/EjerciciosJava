...
public class Person {
    ...
    //Relación con tabla PersonRole
    @ManyToMany(fetch = FetchType.EAGER, targetEntity = PersonRole.class, cascade = CascadeType.PERSIST)
    ...
    public Person(PersonInputDto personInputDto){
        ...
        //Datos de los roles
        /*this.roles = personInputDto.getRoles().stream()
                .map(role -> PersonRole.builder()
                        .roleName(PersonERole.valueOf(role))
                        .build())
                .collect(Collectors.toSet());*/

        this.administrator = personInputDto.isAdministrator();
